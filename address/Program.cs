...
namespace ConsoleApplication12
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
			...
			Person p4 = new Person("Linus","Torvalds","1969-","He made the free os Linux"); //David here, it's GNU/linux you fuckbag!, Joel here he took some shit from GNU so he could make Linux u scumbag!!
